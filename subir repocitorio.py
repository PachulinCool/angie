...
class  subrepo():
	def __init__(self,inter):
		...
		self.interfaz.title("sube tu repositoro")
		self.num1 = StringVar()
		self.num2 = StringVar()
		self.num3 = StringVar()
		self.num4 = StringVar()
	...
	def most(self):
		self.urlgithub = "https://github.com/"+(self.resp3)+"/"+(self.resp4)+".git"
		print(self.urlgithub)
		print(self.resp1)
		print(self.resp2)

	def info(self):
		messagebox.showinfo("Resultado","recuerde que este programa solo funcionara si usted creo una cuenta en github previamente y crea el espacio para su repositorio")
	...
	def lolg(self):
		...
		subprocess.run(["git", "remote", "add", "origin",self.urlgithub])
